<?php if(get_theme_mod('universal_404_image', 'enable')) {?>
	<div class="tag_line tag_line_image" data-background="<?php echo esc_url(get_theme_mod('universal_404_image', get_template_directory_uri() . '/assets/images/1.jpg')); ?>">
<?php } else { ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<h3><?php echo esc_attr(get_theme_mod('universal_404_text_1','No hemos encontrado esa página ...')) ?></h3>
					<h4><?php echo esc_attr(get_theme_mod('universal_404_text_2',"Puedes usar el buscador para encontrar lo que necesitas:")) ?></h4>
					<?php get_search_form(); ?>
