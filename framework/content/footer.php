			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3 col-sm-offset-1 three-block">
						<div class="love-info">
							<h6><?php echo get_theme_mod( 'universal_footer_love', wp_kses( __('We <i class="fa fa-heart fa-fw"></i> creative people', 'universal-wp'), array('i'=> array('class' => array())))); echo ' | ' . date('Y'); ?></h6>
