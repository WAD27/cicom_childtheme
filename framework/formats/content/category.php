<?php $layout_value = get_theme_mod( 'universal_post_type', 'masonry' ); ?>
	<?php if ( have_posts() ) : ?>
		<header class="archive-header">
			<h3 class="archive-title archive-category">Categoría: <?php printf( esc_html__( '%s', 'universal-wp' ), '<span>' . single_cat_title( '', false ) . '</span>' ); ?></h3>
		...
		<?php
				...
				endwhile;
					...
					echo "<p class='not-found'>" . esc_html__('Sin Posts.', 'universal-wp') . "</p>";
				endif;
			?>
				</div>
