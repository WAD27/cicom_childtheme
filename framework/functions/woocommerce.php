...
<div class="universal_head_cart">
    <a class="" href="<?php echo WC()->cart->get_cart_url(); ?>"><span class="badge universal_cart_icon"><?php echo sprintf (_n( '%d', '%d', WC()->cart->cart_contents_count, 'universal-wp' ), WC()->cart->cart_contents_count ); ?></span></a>
</div>
<?php
